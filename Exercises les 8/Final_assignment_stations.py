            ...
            for t in range(len(stations)):
                if sta == stations[t]:
                    ...
                    if eind > begi:
                        ...
                        print("De trein komt niet in {}".format(stationes[eind]))
        else:
...
def omroepen_reis(stationes, begin_stationes, eind_stationes):
    ...
    print("Uw stapt op de trein in {}".format(begin_stationes))
    if (begi + 1) == eindi:
        print("Uw stapt uit de trein in {}".format(eind_stationes))
    else:
